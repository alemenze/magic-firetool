               ...
               fluidRow(
                    ...
                    column(8,
                        ...
                        column(12, align="center",
                            ...
                            column(2,),
                            column(8,markdown("Welcome to the RNA-Seq Analysis Tool by [the Molecular and Genomics Informatics Core](http://www.bioinformagic.io/).
                        ...
                        fluidRow(
                            ...
                            column(6,align = "left",
                                wellPanel(
                                    ...
                                    style="height:300px;",
                                    h4('Hit Count File'),
                                    markdown("You should receive this raw hit count table directly from the Core. It should contain headers for each column. 
                                        ...
                                        Each row should be a unique gene, followed by each sample's respective raw read counts.
                                        "),
                            ...
                            fluidRow(
                                ...
                                column(6,align = "left",
                                    wellPanel(
                                        ...
                                        style="height:300px;",
                                        h4('Comparators'),
                                        markdown("Additionally, you must set what comparisons you wish to view- such as KO vs WT control, or Drug A vs No Drug. This occurs in the comparisons tab of DESeq2. 
                ...
                fluidRow(
                    column(3,
                        wellPanel(
                            ...
                            conditionalPanel("input.DESeq=='Comparisons'",
                                ...
                                tabPanel(title='OutputComparisons', 
                                    hr(), 
                    ...
                    column(9,
                        tabsetPanel(id='DESeq',
                            tabPanel(title='DESeq Counts', hr(), dataTableOutput('deseq_counts')),
                            tabPanel(title='Comparisons',hr(),align='center',
                                ...
                                fluidRow(
                                    column(12, style="margin-bottom:15px;",align='center', actionButton('Compare_groups',"View Comparison", class='btn btn-info', style = "width:25%;",style="margin-top:25px;"),
                                        hr())
                                ),
                                column(12, dataTableOutput('comparison_temp')),
                                fluidRow(
                                    column(12, align='center',actionButton('SaveCompare','Add Comparison to Analysis', class='btn btn-info', style = "width:25%;",style="margin-bottom:25px;")),
                ...
                fluidRow(
                    column(3,
                        wellPanel(
                                ...
                                sliderInput('CWidth', label='Plot Widths: ',  min=50, max=2000, step=10, value=1200)
                            )    
                        ),
                    column(9,
                        tabsetPanel(id='ClusteringPlots',
                            tabPanel(title='PCA', hr(), plotOutput("pcaplot", height='100%'),
                            ...
                            tabPanel(title='Distance Matrix',hr(), plotOutput("distplot", height='100%'),
                                fluidRow(align='center',style="margin-top:25px;",
                            ...
                            tabPanel(title='Eigencorplots',hr(), plotOutput('eigencorplotout', height='100%'),
                                fluidRow(align='center',style="margin-top:25px;",
                ...
                fluidRow(
                    column(3,
                        wellPanel(
                                ...
                                sliderInput('VWidth', label='Plot Widths: ',  min=50, max=2000, step=10, value=1200)
                            )    
                        ),
                    column(9,
                        tabsetPanel(id='VolcanoPlots',
                            tabPanel(title='Volcanoes', hr(), plotOutput("vol_static", height='100%'),
                                fluidRow(align='center',style="margin-top:25px;",
                ...
                fluidRow(
                    column(3,
                        wellPanel(
                                ...
                                sliderInput('HWidth', label='Plot Widths: ',  min=50, max=2000, step=10, value=1200)
                            )    
                        ),
                    column(9,
                        tabsetPanel(id='HeatPlots',
                            tabPanel(title='Heatmap', hr(), plotOutput('heatmap_static', height='100%'),
                                fluidRow(align='center',style="margin-top:25px;",
                ...
                fluidRow(
                    column(3,
                        wellPanel(
                                ...
                                sliderInput('GEWidth', label='Plot Widths: ',  min=50, max=2000, step=10, value=1200)
                            )    
                        ),
                    column(9,
                        tabsetPanel(id='GEPlots',
                            tabPanel('Box Plots', hr(), plotOutput('box_static', height='100%'),
                                fluidRow(align='center',style="margin-top:25px;",
                            ...
                            tabPanel('Violin Plots', hr(), plotOutput('violin_static', height='100%'),
                                fluidRow(align='center',style="margin-top:25px;",
                ...
                fluidRow(
                    column(3,
                        wellPanel(
                                ...
                                sliderInput('VennWidth', label='Plot Widths: ',  min=50, max=2000, step=10, value=1200)  
                            )     
                        ),
                    column(9,
                        tabsetPanel(id='VennPlots',
                            tabPanel(title='Venn Diagrams', hr(), plotOutput("venn_static", height='100%'),
                                fluidRow(align='center',style="margin-top:25px;",
                            ...
                            tabPanel(title='UpSet Plots', hr(), plotOutput("upset_static", height='100%'),
                                fluidRow(align='center',style="margin-top:25px;",
                    ...
                    column(3,
                        wellPanel(
                                ...
                                conditionalPanel("input.Enrichments=='Gene Set Enrichment' || input.Enrichments=='Over Representation'",
                                    ...
                                    sliderInput('EnrichWidth', label='Plot Widths: ',  min=50, max=2000, step=10, value=1200)
                                )
                            )    
                        ),
                    column(9,
                        tabsetPanel(id='Enrichments',
                            ...
                            tabPanel(title='Selected Pathways',hr(),
                                ...
                                conditionalPanel("input.SelectPlotType=='gsea_kegg'",
                                    ...
                                    fluidRow(align='center',style="margin-top:25px;",
                                        column(12, downloadButton('DownloadGSEAKEGGPlot', 'Download GSEA Plot'),style="margin-bottom:50px;")
                                    )
                                ),
                                conditionalPanel("input.SelectPlotType=='ora_kegg'",
                                    fluidRow(
