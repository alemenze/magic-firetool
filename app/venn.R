...
observe({
    updateSelectInput(session, "VennComp1", choices=c(SaveCompareReactive()$compgroups,'None'), selected='None')
    updateSelectInput(session, "VennComp2", choices=c(SaveCompareReactive()$compgroups,'None'), selected='None')
    updateSelectInput(session, "VennComp3", choices=c(SaveCompareReactive()$compgroups,'None'), selected='None')
    updateSelectInput(session, "VennComp4", choices=c(SaveCompareReactive()$compgroups,'None'), selected='None')
    updateSelectInput(session, "VennComp5", choices=c(SaveCompareReactive()$compgroups,'None'), selected='None')
})
...
############################################################################
observe({
    updateSelectizeInput(session, 'upset_compares', choices=SaveCompareReactive()$compgroups, server=TRUE)  
})
